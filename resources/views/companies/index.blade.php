                    ...
                    <tbody>
                        @forelse($companies as $company)
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-ring bg-light text-primary rounded-circle d-flex align-items-center justify-content-center me-3"
                                            style="width: 42px; height: 42px; font-weight: 700;">
                                            {{ strtoupper(substr($company->name, 0, 2)) }}
                                        </div>
                                        <div>
                                            <a href="{{ route('companies.show', $company) }}"
                                                class="fw-bold text-dark text-decoration-none d-block hover-primary">{{ $company->name }}</a>
                                            <span class="text-muted fs-8">Added
