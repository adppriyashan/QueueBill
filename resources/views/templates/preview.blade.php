...
<body>
    ...
    <div class="container">
        ...
        <div class="alert alert-info border-0 rounded-4 shadow-sm max-width-850 mx-auto mb-4 p-3 d-flex align-items-center justify-content-between"
            style="max-width: 850px;">
            <div class="d-flex align-items-center">
                <i class="fas fa-eye text-info fa-lg me-3"></i>
                <div>
                    <h6 class="mb-0 fw-bold">Live Configuration Mode</h6>
                    <span class="fs-8">Template: <strong>{{ $template->title }}</strong> | Slug:
                        <code>/invoices/templates/{{ $template->slug }}</code></span>
                </div>
            </div>
            ...
            <div class="invoice-body">
                <div class="row g-4 mb-5 fs-7">
                    ...
                    <div class="col-12 col-md-4 text-md-end">
                        ...
                        <div class="mb-1"><strong>Issue Date:</strong> <span class="text-muted">May 18, 2026</span>
                        </div>
                ...
                <div class="row justify-content-end text-md-end">
                    <div class="col-12 col-md-5">
                        ...
                        <div class="mt-4">
                            <span class="text-muted fs-8 font-italic">"Your Recurring Revenue, Perfectly
                                Aligned."</span>
                        </div>
                    </div>
                </div>
