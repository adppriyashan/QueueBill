                ...
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-secondary mb-0 fs-7">Design custom layout routing configuration and broadcast
                                overrides.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" value="{{ old('slug') }}" placeholder="e.g. web-hosting-corporate" readonly>
                            </div>
                            @error('slug')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-muted fs-8">Alphanumeric parameter utilized to dynamically render
                                custom layout configurations. Auto-generated dynamically from your title.</div>
                        </div>
