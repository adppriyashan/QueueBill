    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input id="email" type="email" class="form-control border-start-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="admin@queuebill.com">
            </div>
        </div>
        ...
        <div class="text-center">
            <p class="text-muted fs-7 mb-0">
                Don't have an administrative account? <a href="{{ route('register') }}" class="text-primary fw-semibold text-decoration-none">Sign Up</a>
            </p>
        </div>
    </form>
</div>
