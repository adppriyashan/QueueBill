            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('services.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('note') is-invalid @enderror" id="note" name="note" rows="3" placeholder="e.g. Please pay to the following bank account: 8742804982042804">{{ old('note') }}</textarea>
                        @error('note')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
